...
namespace InsaneScatterbrain.ScriptGraph.Editor
{
    ...
    {
        private Dictionary<IScriptNode, ScriptNodeView> viewsByNode;
        ...
        {
            var consumerNodeView = viewsByNode[inPort.Owner];
            var providerNodeView = referenceNode == null ? viewsByNode[outPort.Owner] : nodeViewsByReferenceNode[referenceNode];
        ...
        public ScriptGraphView(string title, bool showDebugInfo)
        {
            ...
            SetupZoom(.1f, ContentZoomer.DefaultMaxScale);
        ...
        private void BuildGroupNodeView(GroupNode groupNode)
        {
            ...
            {
                if (!viewsByNode.ContainsKey(node)) continue;

                var nodeView = viewsByNode[node];
        ...
        private void ConnectOutputNode(IConsumerNode node)
        {
            ...
            foreach (var inPort in node.InPorts)
            {
                ...
                var connectedNodeView = viewsByNode[connectedNode];    // Find the node view for the connected node.
        ...
        private void BuildReferenceNodeView(ReferenceNode referenceNode)
        {
            ...
            {
                var originalNodeView = viewsByNode[providerNode];
            ...
            {
                if (!viewsByNode.ContainsKey(providerNode)) return;
        ...
        public ScriptNodeView GetView(IScriptNode node) => viewsByNode[node];
        ...
        private void BuildGraphView()
        {
            ...
            viewsByNode = new Dictionary<IScriptNode, ScriptNodeView>();
        ...
        private bool NodeIsReferenceNodeOf(Node possibleReferenceNodeView, Node possibleOriginalNodeView)
        {
            ...
            var originalNodeView = viewsByNode[referenceNode.ProviderNode];

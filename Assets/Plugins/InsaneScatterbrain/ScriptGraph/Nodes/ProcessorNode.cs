...
namespace InsaneScatterbrain.ScriptGraph
{
    ...
    public abstract class ProcessorNode : ScriptNode, IProcessorNode
    {
        ...
        /// </summary>
        [Obsolete(
            "Get the random object by calling Get<Random>() instead. This property will be removed in version 2.0.")]
        ...
        private MainThreadCommand onProcessMainThreadCommand;
        private MainThreadCommand processingCompletedCommand;
        
        public override void Initialize()
        {
            base.Initialize();
            
            onProcessMainThreadCommand = new MainThreadCommand(OnProcessMainThread);

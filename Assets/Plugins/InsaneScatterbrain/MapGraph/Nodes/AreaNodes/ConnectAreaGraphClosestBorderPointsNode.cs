    ...
    public class ConnectAreaGraphClosestBorderPointsNode : ProcessorNode 
    {
        ...
        protected override void OnProcess()
        {
            ...
            foreach (var areaPair in areaGraph.Edges)
            {
                ...
                foreach (var pointA in areaB.BorderPoints)
                {
                    foreach (var pointB in areaA.BorderPoints)
                    {
                        ...
                        if (Math.Abs(distance - closestDistance) < .001f)
                        {
                            ...
                            if (totalCentroidDistance > closestCentroidDistance) continue;

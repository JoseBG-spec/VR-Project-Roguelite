...
namespace InsaneScatterbrain.MapGraph
{
    public static class TextureDataDrawingExtensions
    {
        ...
        public static void DrawLine(this TextureData texture, Vector2Int start, Vector2Int end, Color color, int thickness)
        {
            if (thickness < 1)
            {
        ...
        /// <param name="end">The end point.</param>
        /// <param name="color">The line color.</param>
        public static void DrawLine(this TextureData texture, Vector2Int start, Vector2Int end, Color color)
        {
